...
Applies neuroscience-inspired foveal attention to London's data grid:
...
if TYPE_CHECKING:
    from .graph import LondonGraph
    from .models import Anomaly

log = logging.getLogger("london.retina")
...
class AttentionManager:
    """Manages foveal attention across London's grid cells."""

    def __init__(self, graph: LondonGraph) -> None:
        self._graph = graph
    ...
    def _pin_fovea(self, graph: LondonGraph, lat: float, lon: float, name: str, radius: int = 2) -> None:
