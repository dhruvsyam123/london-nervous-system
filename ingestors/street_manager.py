...
log = logging.getLogger("london.ingestors.street_manager")
...
# London bounding box for spatial filtering (easting/northing not needed —
# the API accepts WGS84 lat/lon bounding box on the /works endpoint)
_LONDON_BBOX_PARAMS = {
...
# because the daemon reloads the module but we stash in sys)
import sys as _sys
_TOKEN_KEY = "_london_street_manager_token"
